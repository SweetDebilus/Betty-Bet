    ...
    execute(interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            if ((0, interactionCreate_1.hasRole)('BetManager', interaction.member.roles)) {
                ...
                (0, log_1.log)(`WARNING: AddPoints command executed without proper permissions.`);
            }
        });
    }
};
const handleAddPoints = (interaction) => __awaiter(void 0, void 0, void 0, function* () {
    if (!interaction.isChatInputCommand()) {
        (0, log_1.log)(`ERROR: AddPoints command executed but interaction is not a chat input command.`);
    ...
    if (userId == bettyBettId) {
        ...
        (0, log_1.log)(`INFO: Points added to DebilusCloset.`);
    ...
    if (!pointsManager_1.usersPoints[userId]) {
        ...
        (0, log_1.log)(`WARN: Attempt to add points to non-registered user ID: ${userId}`);
        return;
    }
    ...
    (0, log_1.log)(`INFO: ${pointsToAdd} points added to user ID: ${userId}`);
});
