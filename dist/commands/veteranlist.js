    ...
    execute(interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            if ((0, interactionCreate_1.hasRole)('BetManager', interaction.member.roles)) {
                ...
                (0, log_1.log)(`ERROR: Veteran list command executed without proper permissions.`);
            }
        });
    }
};
const handleVeteranList = (interaction) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!guild || !channel || channel.type !== 0) {
            ...
            (0, log_1.log)('ERROR: Veteran list command used in invalid context.');
            return;
        }
        ...
        if (!daemonPunkRole) {
            ...
            (0, log_1.log)('ERROR: "Dæmon Punk" role not found.');
            return;
        }
        ...
        if (veterans.size === 0) {
            ...
            (0, log_1.log)('INFO: No new veterans found for promotion.');
            return;
        }
        ...
        (0, log_1.log)(`INFO: Veteran list generated with ${sortedVeterans.length} new veterans.`);
    }
    catch (error) {
        ...
        (0, log_1.log)(`ERROR: handleVeteranList failed - ${error}`);
    }
});
